...
/**
 * A repository for {@link Shoe} objects providing a set of JPA methods for working with the database.
...
public interface ShoeRepository extends JpaRepository<Shoe, Long> {
     ...
     */
    List<Shoe> findByPerfumerInAndShoeGenderInOrderByPriceDesc(List<String> shoes, List<String> genders);
     ...
     * @return list of {@link Shoe}.
     */
    List<Shoe> findByShoeInOrShoeGenderInOrderByPriceDesc(List<String> shoes, List<String> genders);
     ...
     * @return list of {@link Shoe}.
     */
    List<Shoe> findByPriceBetweenOrderByPriceDesc(Integer startingPrice, Integer endingPrice);
     ...
     * @return list of {@link Shoe}.
     */
    List<Shoe> findBShoeOrderByPriceDesc(String shoe);
