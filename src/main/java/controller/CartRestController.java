...
public class CartRestController {
    ...
    public ResponseEntity<?> getCart(@PathVariable String email) {
        ...
        List<Shoe> shoeList = user.getShoeList();
    ...
    public ResponseEntity<?> addToCart(@RequestBody Shoe shoe, @AuthenticationPrincipal User userSession) {
        User user = userService.findByEmail(userSession.getEmail());
        user.getShoeList().add(shoe);
    ...
    public ResponseEntity<?> removeFromCart(@RequestBody Shoe shoe, @AuthenticationPrincipal User userSession) {
        User user = userService.findByEmail(userSession.getEmail());
        user.getShoeList().remove(shoe);
