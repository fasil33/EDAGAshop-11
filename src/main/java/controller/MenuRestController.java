...
import com.gmail.merikbest2015.ecommerce.domain.Shoe;
...
public class MenuRestController {
     ...
     */
    private final ShoeService perfumeService;
     ...
     */
    @Autowired
    public MenuRestController(ShoeService perfumeService) {
    ...
    public ResponseEntity<?> findProductsByFilterParams(@RequestBody ShoesSearchFilterDto filterDto) {
        List<Shoe> filter = perfumeService.filter(filterDto.getPerfumers(), filterDto.getGenders(), filterDto.getPrices());
    ...
    public ResponseEntity<?> findByPerfumeGender(@RequestBody ShoesSearchFilterDto filterDto) {
        List<Shoe> gender = perfumeService.findByPerfumeGenderOrderByPriceDesc(filterDto.getPerfumeGender());
    ...
    public ResponseEntity<?> findByPerfumer(@RequestBody ShoesSearchFilterDto filterDto) {
        List<Shoe> perfumer = perfumeService.findByPerfumerOrderByPriceDesc(filterDto.getPerfumer());
